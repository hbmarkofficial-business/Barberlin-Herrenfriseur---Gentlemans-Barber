  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Barberlin Herrenfriseur Gentlemans Barber</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barberlin Herrenfriseur Gentlemans Barber in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barberlin Herrenfriseur Gentlemans Barber | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Barberlin Herrenfriseur Gentlemans Barber | Premium Barbershop Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Barberlin Herrenfriseur Gentlemans Barber",
